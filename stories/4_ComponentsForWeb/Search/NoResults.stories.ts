...
export default {
  ...
  render: (args) => NoResults(args.correctedSearchTerm, args.didYouMeanUrl, args.removeFiltersUrl),
  argTypes: {
    correctedSearchTerm: {
...
export const Default = {
  args: {
    ...
    didYouMeanUrl: 'https://www.bs.ch/suche?text=' + encodeURIComponent(loremIpsum()),
