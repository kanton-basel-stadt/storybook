...
export const TopicLinkList = (title: string, linkGroups: LinkGroup[]) => {
  return html`
    <section class="border-t border-t-gray-200 py-25 lg:py-30 xl:py-40 bg-white">
      <div class="container">
        ...
        <div>
          <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 lg:gap-y-40 xl:gap-y-50">
            ${linkGroups.map(linkGroup => {
              return html`
                <li class="min-h-40">
                  <h3>
                    <a class="link text-lg lg:text-xl flex -mb-10" href="${linkGroup.url}">
                  ...
                  <ul class="mt-5 grid gap-8 xl:mt-10 pl-[50px]">
                    ${linkGroup.links.map(link => {
                      return html`
                        <li>
                          <a class="link font-normal text-base lg:text-lg inline-block" href="${link.url}">
                            ${link.label}
                          </a>
                        </li>
                      `
