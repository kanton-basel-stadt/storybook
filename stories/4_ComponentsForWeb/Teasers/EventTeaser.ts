...
export const EventTeaser = (
  ...
  return html`
    <a href="${url}" class="group/button hyphens-auto block">
      <article
        class="border-green-100 border-2 rounded-large p-10 pb-15 hover:bg-blue-50 transition-all ease-in-out duration-250 h-full"
      >
        <img
          src="${imageUrl}"
        ...
        <address class="block not-italic font-bold text-green-700 mb-40">
          ${venue}
        </address>
        ${hasMultiple
          ? html`
