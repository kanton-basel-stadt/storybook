                ...
                ${questions.map(
                  (question) => html`
                    <li>
                      ...
                      >
                        <span
                          class="relative block text-lg font-medium text-balance text-blue-900 italic before:text-primary-700 before:content-['«'] after:text-primary-700 after:content-['»']"
                        >
                          ${question}
                        </span>
                      </button>
