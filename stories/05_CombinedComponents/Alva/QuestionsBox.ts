                ...
                ${questions.map(
                  (question) => html`
                    <li>
                      ...
                      >
                        <span
                          class="relative block text-balance text-lg font-medium italic text-blue-900 before:text-primary-700 before:content-['«'] after:text-primary-700 after:content-['»']"
                        >
                          ${question}
                        </span>
                      </button>
