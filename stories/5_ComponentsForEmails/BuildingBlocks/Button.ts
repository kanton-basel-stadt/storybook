...
export const Button = (type: 'primary'|'secondary', label: string, url: string) => {
  if (type === 'primary') {
    return html`
  ...
  return html`
    ...
    <![endif]--><!--[if !mso]><!--><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;" data-mjml-tag="mj-button"><tbody><tr><td align="center" bgcolor="#F8F8F8" role="presentation" style="border:1px solid #1E4557;border-radius:21px;cursor:auto;mso-padding-alt:4px 20px 4px 20px;text-align:left;background:#F8F8F8;" valign="middle"><a href="${url}" style="display:inline-block;background:#F8F8F8;color:#1E4557;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;font-weight:700;line-height:32px;margin:0;text-decoration:none;text-transform:none;padding:4px 20px 4px 20px;mso-padding-alt:0px;border-radius:21px;" target="_blank"><!--<![endif]--><!--[--><!--[-->${label}<!--]--><!--]--><!--[if !mso]><!--></a></td></tr></tbody></table><!--<![endif]--><!--[if mso | IE]>
        </center>
      </v:roundrect>
    <![endif]--><!--[if mso | IE]>
            </td>
