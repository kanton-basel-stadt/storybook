...
export const SearchHeader = () => {
  return html`
    <section class="bg-primary-100 py-30 lg:py-50">
      <div class="container"><h2 class="md:text-5xl text-2xl font-bold mb-30 text-primary-700 lg:mb-40">Suche</h2>
        <form>
          <div class="relative h-50">
            <div
                ...
                role="search"
            >
              <label class="block col-span-1 row-start-1 relative" for="searchinput">
              ...
              <button class="button m-[4px] is-strong row-start-1 mobile-only:is-icon-only" type="submit">
                ${Icon('search')}
