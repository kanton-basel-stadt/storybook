...
export const InformationLinkAttachment = (
  ...
  return html`
    <div
      class="info-box ${
        isInverted ? 'bg-primary-700' : 'bg-primary-50'
      } w-full rounded-large p-15 md:col-span-7 lg:max-w-box lg:p-20 lg:pr-30"
    >
      <div
        class="${
          isInverted ? 'text-white' : 'text-primary-700'
        } grid grid-cols-[auto_1fr] items-center gap-10"
      >
        <div>
