...
export const HTMLFrame = (content) => html`
  <!DOCTYPE html><html  lang="de" class="" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" data-capo=""><head>
    ...
    <![endif]-->
    <!--[if !mso]><!--><link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,700"><!--<![endif]-->

    <style type="text/css">
      [style*="Inter"] { font-family: Helvetica, Arial, sans-serif, 'Inter' !important; }
      span { font-family: Helvetica, Arial, sans-serif, 'Inter' !important; }
      div { font-family: Helvetica, Arial, sans-serif, 'Inter' !important; }
      td { font-family: Helvetica, Arial, sans-serif, 'Inter' !important; }
    </style>
    <style>
      #outlook a {
        padding: 0;
